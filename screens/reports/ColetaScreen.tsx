...
export default class ColetaScreen extends ScreenBase{
    ...
    render(){
      ...
      const send = async() => {
        ...
        let coletaModel = new ColetaModel(auth.currentUser?.uid, Timestamp.fromDate(new Date()), location, litros, retorno, galoes, obs);
      ...
      return (
        <ScrollView>
          <View style={main.centered} >
            ...
            <RichTextBox text="Coloque o Obs" placeHolder='Coloque o OBS' onChangeText={(valor) => this.setState({obs: valor})}></RichTextBox>
